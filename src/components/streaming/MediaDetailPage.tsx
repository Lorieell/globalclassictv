      ...
      <div className="p-4 md:p-8 max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr,1.5fr] gap-8 mb-12">
          ...
          <div className="space-y-6">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-black uppercase text-foreground tracking-tight">
              {media.title}
            </h1>
            ...
            {isSerie && media.seasons && media.seasons.length > 0 ? (
              media.seasons.map((season) => (
                <button
                  ...
                  className="group relative min-w-[120px] aspect-video bg-card rounded-xl border-2 border-primary/50 hover:border-primary overflow-hidden transition-all shadow-card hover:shadow-glow"
                >
                  ...
                  <div className="absolute bottom-2 left-0 right-0 text-center">
                    <span className="text-xs font-bold text-white">Saison {season.number}</span>
                  </div>
                </button>
              ))
            ) : (
              ...
              >
                ...
                <div className="absolute bottom-2 left-0 right-0 text-center">
                  <span className="text-xs font-bold text-white">Film</span>
                </div>
              </button>
            )}
          </div>
